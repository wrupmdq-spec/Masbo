    ...
    <div className="min-h-screen bg-stone-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-lg font-semibold text-stone-800 tracking-wide">Crea tu contraseña</h1>
          <p className="text-xs text-stone-400 text-center mt-1">
            {email} inició sesión con una contraseña genérica. Por seguridad, crea una nueva antes de continuar.
          </p>
        </div>

        <form onSubmit={handleSubmit} className="bg-white border border-stone-200 rounded-2xl p-6">
          <label className="block mb-3">
            <span className="block text-xs font-medium text-stone-500 mb-1">Nueva contraseña</span>
            <input
              type="password"
              required
          ...
          <label className="block mb-4">
            <span className="block text-xs font-medium text-stone-500 mb-1">Repite la contraseña</span>
            <input
              type="password"
              required
              autoComplete="new-password"
